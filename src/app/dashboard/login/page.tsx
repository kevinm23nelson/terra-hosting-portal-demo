...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-900 via-purple-800 to-indigo-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        <div className="px-6 py-8 sm:p-10">
          <div className="mb-8 text-center">
            ...
            <h2 className="text-3xl font-extrabold text-gray-900">Terra Hosting Portal</h2>
      ...
      <div className="mt-8 text-center text-xs text-gray-100 opacity-70">
